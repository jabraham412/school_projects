...
public class ApplyBellmanFord {
     ...
     */
    public ApplyBellmanFord(EdgeWeightedDigraph G, int s) {
    ...
    public static void main(String[] args) {
        ...
        vertexWeights = new double [G.V()-1];

        ApplyBellmanFord sp = new ApplyBellmanFord(G, s);
        ...
        /*Find shortest paths from s to all other v*/
        /*calculate and store the vertex weights****/
        /*recalibrate G* from StdIn*****************/
        /*produce G** to StdOut*********************/
        else {
            ...
            StdOut.println(vertexWeights.length);
            for (int i=0; i<vertexWeights.length; i++)
                StdOut.println(vertexWeights[i]);

            Scanner scanner = new Scanner(inputData);
            StdOut.println (scanner.nextInt()-1);
            StdOut.print (scanner.nextInt()-vertexWeights.length);

            while (scanner.hasNextLine()) {
                String line = scanner.nextLine();
                if (!line.startsWith(Integer.toString(vertexWeights.length)))
                    outputData += line + "\n";
            }
            scanner.close();

            Scanner scanner2 = new Scanner(outputData);
            StdOut.println(scanner2.nextLine());
            ...
            while (scanner2.hasNextLine()) {
                ...
                if (tokens.length == 3) {
                    ...
                    double adjustedWeight = weight + vertexWeights[source] - vertexWeights[dest];

                    StdOut.println(source +" "+ dest +" "+ adjustedWeight);
                }
            }
        }
    }
